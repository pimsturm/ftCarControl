...
namespace ftCarWin {
    ...
    /// <summary>
    /// Format log messages in a listbox
    /// </summary>
    public sealed class ListBoxLog : IDisposable {
        ...
        /// <summary>
        /// Create am instance of <see cref="ListBoxLog"/>
        /// </summary>
        /// <param name="listBox">Listbox to display the messages in</param>
        /// <param name="messageFormat">The format displaying messages</param>
        /// <param name="maxLinesInListbox">Maximum number of lines in the listbox</param>
        ...
        /// Log a message
        /// </summary>
        /// <param name="level">The log level see <see cref="Level"/></param>
        /// <param name="message">The message to log</param>
